...
endDate: '2025-10-14'
description: 'IoCare+ 한국 법인 서비스를 미국 법인 요구사항에 맞춰 분리 및 재구축'
tags: ['Next.js', 'TypeScript', 'Docker', 'nginx', 'AWS CloudFront', 'AWS S3',  'AWS ECR', 'AWS EKS', 'ArgoCD', 'Kubernetes', 'CI/CD']
company: "코웨이"
---
...
**서비스 URL**: [NECOA](http://iot.necoa.com/intro) (미국 전용, 앱스토어/구글 플레이스토어 지원)
...
- **Infrastructure**: AWS(CloudFront, S3, ECR, EKS), ArgoCD
