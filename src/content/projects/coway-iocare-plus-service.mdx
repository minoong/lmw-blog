...
tags: ['Next.js', 'TypeScript', 'SCSS', 'Framer Motion', 'WebSocket', 'SWR', 'Jotai', 'AWS CodeDeploy', 'AWS EC2', 'AWS CloundFront', 'AWS Cognito', 'AWS Secrets Manager', 'Github Actions', 'i18next', 'i18n']
company: "코웨이"
---
