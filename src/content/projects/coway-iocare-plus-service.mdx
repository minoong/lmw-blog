...
tags: ['Next.js', 'TypeScript', 'SCSS', 'Framer Motion', 'WebSocket', 'SWR', 'Jotai', 'AWS CodeDeploy', 'AWS EC2', 'AWS CloundFront', 'AWS S3', 'AWS Cognito', 'AWS Secrets Manager', 'Github Actions', 'i18next', 'i18n', 'nginx', 'CI/CD']
company: "코웨이"
---
