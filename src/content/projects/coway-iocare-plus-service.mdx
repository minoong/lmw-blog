...
tags: ['Next.js', 'TypeScript', 'SCSS', 'Framer Motion', 'WebSocket', 'SWR', 'Jotai', 'AWS CodeDeploy', 'AWS EC2', 'AWS CloundFront', 'Github Actions', 'i18next', 'i18n']
company: "코웨이"
---
...
- **State**: Jotai, SWR
- **Deploy**: GitHub Actions, AWS CodeDeploy
...
### 7. API 에러 핸들링 (Next.js 공식 가이드 기준)
